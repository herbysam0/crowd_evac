...
| 2 | **Weight optimisation (GA) — COMPLETE (R0.3)** | NSGA-II (pymoo) multi-objective optimisation of the 13 behavioural force weights against realism_distance and evac_time; calibrated defaults shipped in R0.3 (`domain/constants.py`); §8 EB-1..6 thresholds set empirically; full record in `docs/calibration_report_r03.md`. | 1 | P1 |
